...
void ui_show_banner() {
    ...
    printf("   ______  __    __       ___   .___________.      _______.  ______     ______  __  ___  _______ .___________.\n");
    printf("  /      ||  |  |  |     /   \\  |           |     /       | /  __  \\   /      ||  |/  / |   ____||           |\n");
    printf(" |  ,----'|  |__|  |    /  ^  \\ `---|  |----`    |   (----`|  |  |  | |  ,----'|  '  /  |  |__   `---|  |----`\n");
    printf(" |  |     |   __   |   /  /_\\  \\    |  |          \\   \\    |  |  |  | |  |     |    <   |   __|      |  |     \n");
    printf(" |  `----.|  |  |  |  /  _____  \\   |  |      .----)   |   |  `--'  | |  `----.|  .  \\  |  |____     |  |     \n");
    printf("  \\______||__|  |__| /__/     \\__\\  |__|      |_______/     \\______/   \\______||__|\\__\\ |_______|    |__|     \n");
    printf("\n" C_RESET);
    printf("                                      " C_ITALIC "v1.0 - Connected Edition" C_RESET "\n\n");
}
